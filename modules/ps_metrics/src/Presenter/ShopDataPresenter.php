    ...
    public function getShopData(): array
    {
        ...
        $response = [
            'modules' => [
                ...
                'psEventBus' => [
                    'version' => $psEventBusModule->version,
                ],
                'psAccounts' => [
                    'version' => $psAccountModule->version,
                    'userInfos' => [
                        'email' => $email,
            ...
            'links' => [
                ...
                'external' => [
                    'addonsSearchGA4' => 'https://addons.prestashop.com/fr/recherche?search_query=GA4',
                ],
            ],
            'faq' => [
                'data' => [],
